...
def detector_Callback(image, pointcloud, trigger):
...
def main():
    ...
    tss = ApproximateTimeSynchronizer(
        [Subscriber("/kinect2/hd/image_color", rosImage), Subscriber("/kinect2/sd/points", PointCloud2), Subscriber("/tigger", Header)], queue_size=1,
        slop=10)
